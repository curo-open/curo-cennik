...
├─────────────────┼───────────────────────────┼───────────────────────────────────────────────┼──────────────────────────────────────────────────────────────┤
│          0.0583 │ vv.bodyCelkom*cena        │ Výkon 100,102,103,105,157                     │ "Z" in vv.diagnoza && vv.kod in ['100','102','103','105','15 │
│                 │                           │                                               │ 7']                                                          │
│          0.0266 │ vv.bodyCelkom*cena        │ Výkon 118                                     │ "Z" in vv.diagnoza && vv.kod in ['118']                      │
│          0.0352 │ vv.bodyCelkom*cena        │ Výkon 297                                     │ "Z" in vv.diagnoza && vv.kod in ['297']                      │
...
│            0.02 │ vv.bodyCelkom*cena        │ Výkony 5303,5305                              │ "Z" in vv.diagnoza && vv.kod in ['5303','5305']              │
│         0.01044 │ vv.bodyCelkom*cena        │ Výkon 5308                                    │ "Z" in vv.diagnoza && vv.kod in ['5308']                     │
