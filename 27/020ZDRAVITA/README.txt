...
├─────────────────┼───────────────┼──────────┼───────────────────────────────────┤
│ vek od 18 do 50 │          3.43 │ IDK+cena │ p.kapitacia && p|vekMedzi(18, 50) │
│ vek od 51 do 60 │          3.93 │ IDK+cena │ p.kapitacia && p|vekMedzi(50, 60) │
│ vek od 61 do 80 │          6.31 │ IDK+cena │ p.kapitacia && p|vekMedzi(60, 80) │
│ vek od 81+      │          8.24 │ IDK+cena │ p.kapitacia && p|vekMedzi(80)     │
└─────────────────┴───────────────┴──────────┴───────────────────────────────────┘
...
│            null │ vv.bodyCelkom*CBEU        │ EU - iné ako SVALZ                            │ (p.typ in ['EU']) && vv.typ!='SVaLZ'                         │
...
│          0.0931 │ vv.bodyCelkom*cena        │ Očkovanie proti hepatitíde B                  │ vv.diagnoza=='Z00.0' && vv.kod in ['252b']                   │
...
│            8.95 │ vv.pocet*cena             │ Stanovenie hodnoty NT-proBNP                  │ vv.kod in ['3860']                                           │
│            11.5 │ vv.pocet*cena             │ Stanovenie hodnoty Troponínu                  │ vv.kod in ['4485']                                           │
│           19.75 │ vv.pocet*cena             │ USG – vyšetrenie POCUS                        │ vv.kod in ['44418']                                          │
