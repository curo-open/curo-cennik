...
│ od  1 do dovršenia 2 rokov  │         13.41 │ IDK+cena │ p|vekMedzi(1, 2)   │
│ od  2 do dovršenia 7 rokov  │          8.99 │ IDK+cena │ p|vekMedzi(2, 7)   │
│ od  7 do dovršenia 19 rokov │          5.38 │ IDK+cena │ p|vekMedzi(7, 19)  │
│ od 19 do dovršenia 27 rokov │          3.52 │ IDK+cena │ p|vekMedzi(19, 26) │
└─────────────────────────────┴───────────────┴──────────┴────────────────────┘
...
│          0.0078 │ vv.bodyCelkom*cena        │ Nekapitovaný - SVALZ výkon                    │ !p.kapitacia && !(p.typ in ['EU']) && vv.typ=='SVaLZ'        │
│          0.0193 │ vv.bodyCelkom*cena        │ Nekapitovaný - iné ako SVALZ                  │ !p.kapitacia && !(p.typ in ['EU']) && vv.typ!='SVaLZ'        │
